...
let lableStyle: PanelAttributes['Panel']['style'] = { horizontalAlign: 'center', color: 'red', fontWeight: 'bold', opacity: '0.3' };
export function ReactLogo(): JSX.Element {
    ...
    return (
        <Panel style={{ flowChildren: 'down', verticalAlign: 'center', horizontalAlign: 'center' }}>
            ...
            <Label style={{ ...lableStyle, fontSize: '30px' }} text="编辑 src/hud/components/react_panorama.tsx 以移除此界面" />
            <Button
