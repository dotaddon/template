...
const { getAddonName, getDotaPath,getMapName } = require('./utils');
...
(async () => {
    ...
    console.log('开始加载游廊包=>', addon_name, map_name);
    if (getMapName()==null){ console.log('提示：packjson中mainmap为默认启动地图');}
    if (addon_name == getAddonName() && map_name == null) console.log('提示：你可以用启动项\n--m map_name \n--a addon');
